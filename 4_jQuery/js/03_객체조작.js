...
// 2) 요소 추가 1
// $(A).append(B) : A요소의 자식 요소로 B 요소를 뒷부분에 추가한다.
$("#area1").append("<span>B</span>");

// $(A).prepend(B) : A요소의 자식 요소로 B 요소를 앞부분에 추가한다.
