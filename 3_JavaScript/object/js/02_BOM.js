/*
    open(첫번째, 두번째, 세번째)
     ...
     - 두번째 : 창 이름, 창이름이 같은게 열려있을 경우 새로 열리지 않고 이미 열린 곳에서 새로고침
     - 세번째 : 새창의 특성들(브라우저마다 적용범위가 다름)
                - width : 창의 너비(px), height : 창의 높이(px),
                resizable : 창 크기 조절 가능 여부, location : 주소창,
                menubar : 메뉴바, scrollbars : 스크롤바, status : 상태표시줄,
                toolbar : 도구모음
*/
